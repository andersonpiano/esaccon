			...
			<div class="container">
				<div class="slider-container">
					<div class="intro-text">
						<div class="intro-lead-in">Profissionais qualificados</div>
						<div class="intro-heading">Esaccon Contabilidade</div>
						<a href="<?php echo base_url(); ?>#portfolio" class="page-scroll btn btn-xl">Conheça nossos serviços</a>
					</div>
				</div>
			</div>
		</header>
				...
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="section-title">
							<h2>SOBRE</h2>
							<p>História da Esaccon pode ser escrita nesse campo.</p>
						</div>
					</div>
				</div>

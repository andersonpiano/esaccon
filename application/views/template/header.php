		...
		<nav class="navbar navbar-default navbar-shrink navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header page-scroll">
					...
					<a class="navbar-brand page-scroll" href="#page-top"><img src="<?php echo base_url(); ?>public/images/logo-reduzida.png" alt="ESACCON"></a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a class="page-scroll" href="<?php echo base_url(); ?>#course">Nova</a>
						</li>
						<li>
							<a class="page-scroll" href="<?php echo base_url(); ?>#team">Novo</a>
						</li>
						<li>
							<a class="page-scroll" href="<?php echo base_url(); ?>#contact">Contato</a>
						</li>
						<li>
							<a class="page-scroll" href="<?php echo base_url(); ?>restrict">Sistema</a>
						</li>
					</ul>
				</div>
				<!-- /.navbar-collapse -->
